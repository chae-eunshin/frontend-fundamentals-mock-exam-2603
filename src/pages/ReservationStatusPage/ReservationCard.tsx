...
export function ReservationCard({ reservation: res, roomName, onCancel }: Props) {
  return (
    <div css={css`padding: 14px 16px; border-radius: 14px; background: ${colors.grey50}; border: 1px solid ${colors.grey200};`}>
      <ListRow
        contents={
          <ListRow.Text2Rows
            top={roomName}
